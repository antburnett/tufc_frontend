  ...
  <Layout>
    ...
    <main>
      <div class="relative pt-16 pb-32 flex content-center items-center justify-center" style="min-height: 75vh;">
        <div class="absolute top-0 w-full h-full bg-center bg-cover" style='background-image: url("/images/tufc-shirt-rear.jpg");'>
        ...
        <div class="container relative mx-auto">
          <div class="items-center flex flex-wrap">
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                <h1 class="text-white font-semibold text-2xl lg:text-5xl">
                  About Turramurra United Football Club.
                </h1>
                <p class="mt-4 text-lg text-gray-300">
                  We're a community-focused football club on Sydney’s upper north shore. Run entirely by parent volunteers, we welcome Minis and Juniors, Youth,
        ...
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap">
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  <div class="text-white text-center inline-flex items-center justify-center w-48 h-48 mb-5 shadow-lg rounded-full bg-tufc_red">
                    <a href="/play/">
                      <g-image src="~/assets/images/ball-and-hands.jpg" class="shadow-lg rounded-full w-full mx-auto" alt="ball and ball-and-hands"></g-image
                    ></a>
                  </div>
                  <h6 class="text-xl font-semibold">Players and Training</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    All you need to know about registering, grading, your team, training and the draw.
                  </p>
                  <a href="/play/" class="font-bold text-gray-800 mt-8">Read more!</a>
                </div>
              </div>
            </div>
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
              <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  <div class="text-white text-center inline-flex items-center justify-center w-48 h-48 mb-5 shadow-lg rounded-full  bg-tufc_blue">
                    <a href="/news/">
                      <g-image src="~/assets/images/social-events-1.jpg" class="shadow-lg rounded-full w-full mx-auto" alt="ball and ball-and-hands"></g-image>
                    </a>
                  </div>
                  <h6 class="text-xl font-semibold">News and Events</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Keep on top of the Club’s updates, social and fundraising activities.
                  </p>
                  <a href="/news/" class="font-bold text-gray-800 mt-8">Read more!</a>
                </div>
              </div>
            </div>
            ...
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  <div class="text-white text-center inline-flex items-center justify-center w-48 h-48 mb-5 shadow-lg rounded-full  bg-tufc_yellow">
                    <a href="/coaches-managers/">
                      <g-image src="~/assets/images/coaches-board.jpg" class="shadow-lg rounded-full w-full mx-auto" alt="ball and ball-and-hands"></g-image
                    ></a>
                  </div>
                  <h6 class="text-xl font-semibold">Coaches & Managers</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Rules and regulations, professional training, forms, and more.
                  </p>
                  <a href="/coaches-managers/" class="font-bold text-gray-800 mt-8">Read more!</a>
                </div>
              </div>
            </div>
          </div>
