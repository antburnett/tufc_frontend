<template>
  <Layout>
    <section class="pb-20 bg-gray-300 pt-20 hidden lg:block">
      <div class="container mx-auto px-4">
        <div class="flex flex-wrap ">
          <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
            <h3 class="text-3xl mb-2 font-semibold leading-normal">
              Latest news from Turramurra United
            </h3>
            ...
            <a href="/about/" class="font-bold text-gray-800 mt-8">Learn more about Turramurra United!</a>
          </div>
